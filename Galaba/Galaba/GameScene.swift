...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    private func setupUI(){
        ...
        */
        ...
        // label to show how many enemies are left
    ...
    // random function, should be in utils
